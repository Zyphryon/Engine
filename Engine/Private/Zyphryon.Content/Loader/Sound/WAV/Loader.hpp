...
#include "Zyphryon.Audio/Codec.hpp"
...
namespace Content
{
    /// \brief Represents a \ref Loader for uncompressed WAV files.
    class WAVLoader final : public Loader, Audio::Codec
    {
    public:
        ...
        {
            static constexpr ConstStr8 EXTENSION_LIST[] = { "wav" };
