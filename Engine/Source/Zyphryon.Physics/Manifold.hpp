...
namespace Physics
{
    ...
    public:
        ...
        ZY_INLINE void SetNormal(AnyVector2<Type> Normal)
        {
            mNormal.Set(Normal.GetX(), Normal.GetY(), static_cast<Type>(0));
        }

        /// \brief Sets the collision normal from a 3D vector.
        ///
        /// \param Normal The 3D normal vector of the collision.
        ZY_INLINE void SetNormal(AnyVector3<Type> Normal)
        {
            mNormal = Normal;
        }
        ...
        ZY_INLINE AnyVector3<Type> GetNormal() const
        {
            return mNormal;
        }
        ...
        ZY_INLINE void SetPenetration(Type Penetration)
        {
        ...
        ZY_INLINE Type GetPenetration() const
        {
            return mPenetration;
        }
        ...
        ZY_INLINE void AddContact(AnyVector2<Type> Point)
        {
            mContacts.Append(Point);
        }

        /// \brief Adds a 3D contact point to the manifold.
        ///
        /// \param Point The 3D contact point to add.
        ZY_INLINE void AddContact(AnyVector3<Type> Point)
        {
            mContacts.Append(Point);
        }
        ...
        ZY_INLINE ConstSpan<AnyVector3<Type>> GetContacts() const
        {
            return mContacts;
        }
    ...
    private:
        ...
        Type                                            mPenetration;
        Sequence<AnyVector3<Type>, kMaxCollisionPoints> mContacts;
    };
