...
#include "Zyphryon.Graphic/Backend/Driver.hpp"
#include <d3d11_4.h>
...
namespace Graphic
{
    ...
    private:
        ...
        struct D3D11Properties final
        {
            ...
            Array<DXGI_SAMPLE_DESC, 16 + 1> Multisample { 0 };   // TODO Add per format
    ...
    private:
        ...
        /// \return A reference to the existing or newly created sampler state resource that matches the specified descriptor.
