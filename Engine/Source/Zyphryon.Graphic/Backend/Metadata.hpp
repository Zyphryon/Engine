...
namespace Graphic
{
    ...
    struct TDescTextureFormat final
    {
    ...
    /// \brief Get the metadata descriptor for the texture format.
    ///
    /// \param Format The texture format to query.
    /// \return The metadata descriptor containing format properties.
    constexpr TDescTextureFormat GetMetadata(Graphic::TextureFormat Format)
    {
        static constexpr TDescTextureFormat kMetadata[] = {
    ...
    struct TDescVertexFormat final
    {
    ...
    /// \brief Get the metadata descriptor for the vertex format.
    ///
    /// \param Format The vertex format to query.
    /// \return The metadata descriptor containing format properties.
    constexpr TDescVertexFormat GetMetadata(Graphic::VertexFormat Format)
    {
        static constexpr TDescVertexFormat kMetadata[] = {
