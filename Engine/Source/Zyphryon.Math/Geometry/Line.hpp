...
inline namespace Math
{
    ...
    public:
        ...
        ZY_INLINE constexpr Line(Vector2 Start, Vector2 End)
            : mStart { Start },
              mEnd   { End }
        {
        }
        ...
        ZY_INLINE constexpr void Set(Vector2 Start, Vector2 End)
        {
            mStart = Start;
            mEnd   = End;
        }
        ...
        ///
        /// \param Start The new start point.
        ZY_INLINE constexpr void SetStart(Vector2 Start)
        {
            mStart = Start;
        }
        ...
        ZY_INLINE constexpr Vector2 GetStart() const
        {
            return mStart;
        }
        ...
        ///
        /// \param End The new end point.
        ZY_INLINE constexpr void SetEnd(Vector2 End)
        {
            mEnd = End;
        }
        ...
        ZY_INLINE constexpr Vector2 GetEnd() const
        {
            return mEnd;
        }
        ...
        ZY_INLINE constexpr Real32 GetLengthSquared() const
        {
        ...
        ZY_INLINE Vector2 GetDirection() const
        {
            ZY_ASSERT(mStart != mEnd, "Cannot compute direction of a zero-length line");
        ...
        ZY_INLINE constexpr Vector2 GetMidpoint() const
        {
        ...
        ZY_INLINE constexpr Vector2 GetNormal() const
        {
        ...
        /// \brief Gets a point on the line segment by linear interpolation.
        ///
        /// \param Factor The interpolation parameter (0 = start, 1 = end).
        /// \return The interpolated point.
        ZY_INLINE constexpr Vector2 GetPoint(Real32 Factor) const
        {
            return ::Lerp(mStart, mEnd, Factor);
        }
        ...
        ZY_INLINE constexpr Bool Test(Line Other) const
        {
            ...
            return (::IsAlmostZero(O1) && Contains(Other.mStart)
                ||  ::IsAlmostZero(O2) && Contains(Other.mEnd)
                ||  ::IsAlmostZero(O3) && Other.Contains(mStart)
                ||  ::IsAlmostZero(O4) && Other.Contains(mEnd));
        }
        ...
        ZY_INLINE constexpr Bool operator==(Line Other) const
        {
    ...
    public:
        ...
        /// \brief Gets a unit line segment in a specified direction from the origin.
        ///
        ...
        ZY_INLINE static constexpr Line Unit(Vector2 Direction)
        {
            ZY_ASSERT(!Direction.IsAlmostZero(), "Direction must be non-zero");

            return Line(Vector2::Zero(), Vector2::Normalize(Direction));
        }

        /// \brief Gets a unit line segment along the X-axis from (0, 0) to (1, 0).
        ///
        /// \return A unit line segment along the X-axis.
        ZY_INLINE static constexpr Line UnitX()
        {
            return Line(Vector2::Zero(), Vector2::UnitX());
        }

        /// \brief Gets a unit line segment along the Y-axis from (0, 0) to (0, 1).
        ///
        /// \return A unit line segment along the Y-axis.
        ZY_INLINE static constexpr Line UnitY()
        {
        ...
        ZY_INLINE static constexpr Line Lerp(Line Start, Line End, Real32 Percentage)
        {
            ZY_ASSERT(Percentage >= 0.0f && Percentage <= 1.0f, "Percentage must be in [0, 1]");

            return Line(::Lerp(Start.mStart, End.mStart, Percentage),
                        ::Lerp(Start.mEnd,   End.mEnd,   Percentage));
        }
        ...
        /// \return A line resulting from transforming the line with the matrix.
        ZY_INLINE static constexpr Line Transform(Line Source, ConstRef<Matrix3x2> Matrix)
        {
            return Line(Matrix3x2::Project(Matrix, Source.GetStart()),
