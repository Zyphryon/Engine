...
inline namespace Math
{
    ...
    public:
        ...
        /// \brief Sets the scale vector for the transform (Z scale = 1.0f).
        ///
        ...
        ///
        /// \return The quaternion representing the current rotation.
        ...
        /// \brief Scales the transform non-uniformly by a 2D vector (Z scale = 1.0f).
        ///
        ...
        /// \brief Scales the transform non-uniformly by a 3D vector.
        ///
        ...
        /// \brief Rotates the transform in world space by pitch and yaw (X = pitch, Y = yaw, in radians).
        ///
        ...
        /// \brief Rotates the transform in world space using Euler angles (X = pitch, Y = yaw, Z = roll, in radians).
        ///
