...
namespace Scene
{
    ...
    public:
        ...
        ZY_INLINE Entity(flecs::entity_t Handle)
            : mHandle { Handle }
        {
        }
        ...
        {
            mHandle.each(Forward<Callable>(Callback));
        }
        ...
        ZY_INLINE Text GetName() const
        {
            ...
            return Text(Name.c_str(), Name.size());
        }
        ...
        {
            const flecs::string_view Name(mHandle.doc_name());
            return Text(Name.c_str(), Name.size());
        }
