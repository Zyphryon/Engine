...
namespace Render
{
    ...
    public:
        ...
        struct Object final
        {
            ...
            ZY_INLINE Object(UInt8 Type, UInt32 Slot)
                : Type { Type },
                  Slot { Slot }
            {
            }
        ...
        struct Command final
        {
            ...
            ZY_INLINE Command(UInt64 Order, UInt64 Group, Object Entry)
                : Order { Order },
                  Group { Group },
                  Entry { Entry }
            {
        ...
        {
            ZY_ASSERT(Pipeline, "Pipeline cannot be null.");
        ...
        ZY_INLINE void Poll(AnyRef<Function> Callback)
        {
            for (Ref<Queue> Queue : mQueues)
            {
                ...
                {
                    Callback(Base->Entry.Type, ConstSpan(Base, Queue.GetSize() - Start));
                }
    ...
    private:
        ...
        ZY_INLINE static UInt64 GenerateOrderKey(Priority Priority, UInt16 Pipeline, UInt16 Material, UInt16 Mesh, Real32 Depth)
        {
            switch (Priority)
            {
        ...
        ZY_INLINE static UInt64 GenerateOpaqueOrderKey(UInt16 Pipeline, UInt16 Material, UInt16 Mesh, Real32 Depth)
        {
        ...
        ZY_INLINE static UInt64 GenerateAlphaOrderKey(UInt16 Pipeline, UInt16 Material, UInt16 Mesh, Real32 Depth)
        {
        ...
        ZY_INLINE static UInt64 GenerateGroupKey(UInt16 Pipeline, UInt16 Material, UInt16 Mesh)
        {
            return (static_cast<UInt64>(Pipeline & 0x3FFu)  << 54) |    // [10:Pipeline]
                   (static_cast<UInt64>(Material & 0x3FFFu) << 40) |    // [14:Material]
                   (static_cast<UInt64>(Mesh     & 0xFFFFu) << 24);     // [16:Mesh]
        ...
        ZY_INLINE static UInt32 DepthToBits(Real32 Depth)
        {
