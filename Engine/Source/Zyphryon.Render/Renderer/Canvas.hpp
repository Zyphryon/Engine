...
namespace Render
{
    ...
    public:
        ...
        void SetPipeline(Type Type, ConstRetainer<Graphic::Technique> Pipeline);
        ...
        void DrawText(ConstRef<TextStyle> Style, Text Content, ConstRef<Matrix3x2> Transform, Real32 Order, UInt32 Effect = 0);
    ...
    private:
        ...
        void Bind(ConstPtr<Graphic::Technique> Pipeline, ConstPtr<Graphic::Material> Material);
    ...
    private:
        ...
        using Pipelines = Array<Retainer<Graphic::Technique>, Enum::Count<Type>()>;
        ...
        struct SpriteCommand final
        {
            ...
            ConstPtr<Graphic::Technique> Pipeline;
