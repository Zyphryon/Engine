...
namespace Engine
{
    ...
    public:
        ...
        ZYPHRYON_INLINE Bool IsFocused() const
        {
        ...
        ZYPHRYON_INLINE Bool IsBorderless() const
        {
        ...
        ZYPHRYON_INLINE Bool IsWindowed() const
        {
        ...
        ZYPHRYON_INLINE Bool IsFullscreen() const
        {
            return (SDL_GetWindowFlags(mHandle) & SDL_WINDOW_FULLSCREEN) != 0;
        }
        ...
        ZYPHRYON_INLINE void SetConstrain(Bool Constrain)
        {
        ...
        ZYPHRYON_INLINE Bool IsConstrained() const
        {
