...
inline namespace Base
{
    ...
    public:
        ...
        ZYPHRYON_INLINE void SerializeBool(Ref<Bool> Value)
        {
        ...
        ZYPHRYON_INLINE void SerializeEnum(Ref<Type> Value)
        {
            if constexpr (IsReader)
            {
        ...
        /// \param Value Reference to the value.
        template<typename Type>
        ZYPHRYON_INLINE void SerializeInt8(Ref<Type> Value)
        {
            if constexpr (IsReader)
            {
        ...
        /// \param Value Reference to the value.
        template<typename Type>
        ZYPHRYON_INLINE void SerializeUInt8(Ref<Type> Value)
        {
            if constexpr (IsReader)
            {
        ...
        /// \param Value Reference to the value.
        template<typename Type>
        ZYPHRYON_INLINE void SerializeInt16(Ref<Type> Value)
        {
            if constexpr (IsReader)
            {
        ...
        /// \param Value Reference to the value.
        template<typename Type>
        ZYPHRYON_INLINE void SerializeUInt16(Ref<Type> Value)
        {
            if constexpr (IsReader)
            {
        ...
        /// \param Value Reference to the value.
        template<typename Type>
        ZYPHRYON_INLINE void SerializeInt32(Ref<Type> Value)
        {
            if constexpr (IsReader)
            {
        ...
        /// \param Value Reference to the value.
        template<typename Type>
        ZYPHRYON_INLINE void SerializeUInt32(Ref<Type> Value)
        {
            if constexpr (IsReader)
            {
        ...
        /// \param Value Reference to the value.
        template<typename Type>
        ZYPHRYON_INLINE void SerializeInt64(Ref<Type> Value)
        {
            if constexpr (IsReader)
            {
        ...
        /// \param Value Reference to the value.
        template<typename Type>
        ZYPHRYON_INLINE void SerializeUInt64(Ref<Type> Value)
        {
            if constexpr (IsReader)
            {
        ...
        /// \param Value Reference to the value.
        template<typename Type>
        ZYPHRYON_INLINE void SerializeReal32(Ref<Type> Value)
        {
            if constexpr (IsReader)
            {
        ...
        /// \param Value Reference to the value.
        template<typename Type>
        ZYPHRYON_INLINE void SerializeReal64(Ref<Type> Value)
        {
            if constexpr (IsReader)
            {
        ...
        /// \param Value Reference to the value.
        template<typename Type>
        ZYPHRYON_INLINE void SerializeReal(Ref<Type> Value)
        {
        ...
        /// \param Value Reference to the value.
        template<typename Type>
        ZYPHRYON_INLINE void SerializeObject(Ref<Type> Value)
        {
            if constexpr(IsEqual<Type, Bool>)
            {
                SerializeBool(Value);
            }
            ...
            else if constexpr(IsIntegral<Type>)
            {
            ...
            else if constexpr(IsEqual<Type, Str8, ConstStr8>)
            {
                SerializeText(Value);
            }
        ...
        template<typename Type>
        ZYPHRYON_INLINE void SerializeArray(Ref<Type> Array)
        {
        ...
        template<typename Type>
        ZYPHRYON_INLINE void SerializeVector(Ref<Type> Vector)
        {
            if constexpr (IsReader)
            {
