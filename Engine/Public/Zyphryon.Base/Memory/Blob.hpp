...
inline namespace Base
{
    ...
    public:
        ...
        ZYPHRYON_INLINE Blob(UInt32 Size)
        ...
        template<typename Type>
        ZYPHRYON_INLINE Blob(Type Pointer, UInt32 Size, Deleter Deleter)
        ...
        ZYPHRYON_INLINE Blob(AnyRef<Blob> Other)
