...
namespace Scene
{
    ...
    public:
        ...
        ZYPHRYON_INLINE void Attach(Entity Component)
        {
        ...
        ZYPHRYON_INLINE void Attach(Entity Tag, Entity Component)
        {
        ...
        ZYPHRYON_INLINE Ptr<void> Ensure(Entity Component)
        {
        ...
        /// \param Component The relation's target component.
        /// \return A pointer to the component’s raw storage.
        ZYPHRYON_INLINE Ptr<void> Ensure(Entity Tag, Entity Component)
        {
        ...
        ZYPHRYON_INLINE void Detach(Entity Component)
        {
        ...
        /// \param Tag    The relation's tag component.
        /// \param Target The relation's target component.
        ZYPHRYON_INLINE void Detach(Entity Tag, Entity Target)
        {
        ...
        /// \param Component The entity representing the component type.
        /// \return `true` if the component is present, `false` otherwise.
        ZYPHRYON_INLINE Bool Contains(Entity Component) const
        {
        ...
        /// \param Target The relation's target component.
        /// \return `true` if the relation is present, `false` otherwise.
        ZYPHRYON_INLINE Bool Contains(Entity Tag, Entity Target) const
        {
        ...
        ZYPHRYON_INLINE auto Lookup(Entity Component) const
        {
        ...
        /// \param Target The relation's target component.
        /// \return Pointer to the raw component, or `nullptr` if not present.
        ZYPHRYON_INLINE auto Lookup(Entity Tag, Entity Target) const
        {
        ...
        ///
        /// \param Component The entity representing the component type.
        ZYPHRYON_INLINE void Notify(Entity Component) const
        {
        ...
        /// \param Tag    The relation's tag component.
        /// \param Target The relation's target component.
        ZYPHRYON_INLINE void Notify(Entity Tag, Entity Target) const
        {
        ...
        ///
        /// \param Component The entity representing the component type.
        ZYPHRYON_INLINE void Enable(Entity Component)
        {
        ...
        /// \param Tag    The relation's tag component.
        /// \param Target The relation's target component.
        ZYPHRYON_INLINE void Enable(Entity Tag, Entity Target)
        {
        ...
        ///
        /// \param Component The entity representing the component type.
        ZYPHRYON_INLINE void Disable(Entity Component)
        {
        ...
        /// \param Tag    The relation's tag component.
        /// \param Target The relation's target component.
        ZYPHRYON_INLINE void Disable(Entity Tag, Entity Target)
        {
        ...
        ZYPHRYON_INLINE void SetParent(Entity Parent)
        {
        ...
        ZYPHRYON_INLINE void SetArchetype(Entity Archetype)
        {
