...
namespace Content
{
    ...
    public:
        ...
        ZYPHRYON_INLINE explicit Scope(ConstTracker<Resource> Resource)
            : mResource { Resource }
        {
        }
        ...
        ZYPHRYON_INLINE ConstTracker<Resource> GetResource() const
        {
            return mResource;
        }
        ...
        ZYPHRYON_INLINE void Mark(ConstTracker<Resource> Dependency)
        {
