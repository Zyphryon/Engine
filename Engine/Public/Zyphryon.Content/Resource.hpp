...
namespace Content
{
    ...
    public:
        ...
        ZYPHRYON_INLINE explicit Resource(AnyRef<Uri> Key)
            : mKey      { Move(Key) },
              mStatus   { Status::Idle },
              mMemory   { 0 },
        ...
        ZYPHRYON_INLINE ConstRef<Uri> GetKey() const
        {
            return mKey;
        }
        ...
        ZYPHRYON_INLINE Bool Transition(Status Comparison, Status Status)
        {
        ...
        ZYPHRYON_INLINE void SetMemory(UInt64 Memory)
        {
            mMemory = Memory;
        }
        ...
        ZYPHRYON_INLINE UInt64 GetMemory() const
        {
            return mMemory;
        }
        ...
        ZYPHRYON_INLINE Bool HasFinished() const
        {
        ...
        ZYPHRYON_INLINE Bool HasFailed() const
        {
        ...
        ZYPHRYON_INLINE Bool HasCompleted() const
        {
        ...
        ZYPHRYON_INLINE void SetPolicy(Policy Policy)
        {
            mPolicy = Policy;
        }
        ...
        ZYPHRYON_INLINE Bool HasPolicy(Policy Policy) const
        {
    ...
    public:
        ...
        ZYPHRYON_INLINE explicit AbstractResource(AnyRef<Uri> Key)
            : Resource(Move(Key))
        {
        }
    ...
    protected:
        ...
        ZYPHRYON_INLINE Bool OnCreate(Ref<Service::Host> Host) override
        {
        ...
        ZYPHRYON_INLINE void OnDelete(Ref<Service::Host> Host) override
        {
            GetCache().SetMemoryUsage(GetCache().GetMemoryUsage() - GetMemory());
    ...
    public:
        ...
        ZYPHRYON_INLINE static Ref<Cache<Type>> GetCache()
        {
