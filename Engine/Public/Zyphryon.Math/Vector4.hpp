...
inline namespace Math
{
    ...
    public:
        ...
        ZYPHRYON_INLINE Vector4(Real32 X, Real32 Y, Real32 Z, Real32 W = 0.0f)
        ...
        ZYPHRYON_INLINE Vector2 GetXY() const
        {
        ...
        ZYPHRYON_INLINE Vector3 GetXYZ() const
        {
        ...
        ZYPHRYON_INLINE Vector4 operator-() const
        {
        ...
        ZYPHRYON_INLINE Ref<Vector4> operator++()
        {
    ...
    public:
        ...
        ZYPHRYON_INLINE static Vector4 Zero()
        {
            return Vector4();
        }
        ...
        ZYPHRYON_INLINE static Vector4 One()
        {
        ...
        ZYPHRYON_INLINE static Vector4 UnitX()
        {
        ...
        ZYPHRYON_INLINE static Vector4 UnitY()
        {
        ...
        ZYPHRYON_INLINE static Vector4 UnitZ()
        {
        ...
        ZYPHRYON_INLINE static Vector4 UnitW()
        {
    ...
    private:
        ...
        ZYPHRYON_INLINE explicit Vector4(__m128 Register)
            : mRegister { Register }
        {
        }
