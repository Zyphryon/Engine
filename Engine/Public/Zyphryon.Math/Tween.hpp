...
inline namespace Math
{
    ...
    public:
        ...
        ZYPHRYON_INLINE Tween(Type Start, Type End, Real64 Time, Easing Function = Easing::Linear)
            : mStart       { Start },
              mEnd         { End },
              mTime        { Time },
              mAccumulator { 0 },
        ...
        ZYPHRYON_INLINE Bool IsIdle() const
        {
        ...
        ZYPHRYON_INLINE Bool IsComplete() const
        {
