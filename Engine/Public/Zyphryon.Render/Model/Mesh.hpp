...
namespace Render
{
    ...
    public:
        ...
        /// \brief Maximum number of attributes that a mesh can contain.
        static constexpr UInt32 kMaxAttributes = Enum::Count<Graphic::VertexSemantic>();
        ...
        struct Attribute final
        {
            ...
            ZYPHRYON_INLINE constexpr Attribute(UInt32 Length, UInt32 Offset, UInt32 Stride)
                : Length { Length },
                  Offset { Offset },
                  Stride { Stride }
            {
        ...
        struct Primitive final
        {
            ...
            ConstRef<Attribute> GetAttribute(Graphic::VertexSemantic Semantic) const
            {
        ...
        {
            /// CPU-side vertex data blob.
            Blob   Bytes;

            /// GPU-side vertex buffer object identifier.
            Graphic::Object Buffer = 0;

            /// \brief Sets the data for this container, replacing any existing data.
            ///
            /// \param Data The new data blob to be stored in the container.
            ZYPHRYON_INLINE void SetData(AnyRef<Blob> Data)
            {
                Bytes = Move(Data);
            }
        };
    ...
    public:
        ...
        ZYPHRYON_INLINE Graphic::Object GetVertices() const
        {
        ...
        ZYPHRYON_INLINE void AddPrimitive(AnyRef<Primitive> Data)
        {
        ...
        ZYPHRYON_INLINE ConstRef<Primitive> GetPrimitive(UInt8 Index) const
        {
        ...
        ZYPHRYON_INLINE ConstSpan<Primitive> GetPrimitives() const
        {
            return mPrimitives;
        }
