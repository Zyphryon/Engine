...
namespace Render
{
    ...
    public:
        ...
        /// \brief Represents the collection of materials assigned to a model, typically one per mesh primitive.
        using Palette = Vector<Tracker<Graphic::Material>>;
    ...
    public:
        ...
        ZYPHRYON_INLINE ConstTracker<Mesh> GetMesh() const
        {
            return mMesh;
        }
        ...
        ZYPHRYON_INLINE ConstTracker<Graphic::Material> GetMaterial(UInt32 Slot) const
        {
