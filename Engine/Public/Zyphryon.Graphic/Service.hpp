...
namespace Graphic
{
    ...
    public:
        ...
        ZYPHRYON_INLINE auto Allocate(Usage Usage, UInt32 Length, UInt32 Stride = sizeof(Format)) -> Tuple<Ptr<Format>, Stream>
        {
        ...
        template<typename Format>
        ZYPHRYON_INLINE auto Allocate(Usage Usage, ConstSpan<Format> Data) -> Stream
        {
    ...
    private:
        ...
        static constexpr UInt kConcurrency = 2; // TODO: Support triple buffering.
...
#define DEFINE(Name, ...) using Name = Command<CommandType::Name, __VA_ARGS__>;
        ...
        ZYPHRYON_INLINE void WriteCommand(Ref<InFlightFrame> Frame, AnyRef<Arguments>... Parameters)
        {
        ...
        ZYPHRYON_INLINE Ref<InFlightFrame> GetProducerFrame()
        {
        ...
        ZYPHRYON_INLINE Ref<InFlightFrame> GetConsumerFrame()
        {
        ...
        /// \return Pair containing a writable CPU pointer to the allocated memory and the stream descriptor.
        template<typename Format>
        ZYPHRYON_INLINE auto AllocateFrame(Ref<InFlightArena> Arena, UInt32 Length, UInt32 Stride)
        {
