...
namespace Graphic
{
    ...
    public:
        ...
        ZYPHRYON_INLINE constexpr Color()
            : mComponents { 0 }
        {
        }
        ...
        ZYPHRYON_INLINE constexpr Color(Real32 Red, Real32 Green, Real32 Blue, Real32 Alpha = 1.0f)
    ...
    public:
        ...
        ZYPHRYON_INLINE constexpr static UInt32 PackRGBA8(UInt8 Red, UInt8 Green, UInt8 Blue, UInt8 Alpha = 255)
        {
        ...
        /// \return A 32-bit packed RGBA value.
        ZYPHRYON_INLINE constexpr static UInt32 PackRGBA32F(Real32 Red, Real32 Green, Real32 Blue, Real32 Alpha = 1.0f)
        {
            if constexpr (ZYPHRYON_LITTLE_ENDIAN)
            {
        ...
        ZYPHRYON_INLINE constexpr static Color Lerp(ConstRef<Color> Start, ConstRef<Color> End, Real32 Percentage)
        {
