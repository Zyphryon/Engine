...
namespace Audio::Miniaudio
{
    ...
    Bool Driver::Initialize(Text Device)
    {
    ...
    void Driver::Drain(Ref<Completion> Completion)
    {
        mPlaybacks.RemoveFastSomeIf([&](Object Handle)
        {
            Ref<Source> Source = mSources[Handle];
    ...
    void Driver::SetMasterVolume(Real32 Volume)
    {
    ...
    Real32 Driver::GetMasterVolume() const
    {
    ...
    void Driver::SetSubmixVolume(Category Category, Real32 Volume)
    {
    ...
    Real32 Driver::GetSubmixVolume(Category Category) const
    {
    ...
    void Driver::SetListenerPose(ConstRef<Pose> Pose)
    {
    ...
    void Driver::SetListenerCone(Angle InnerAngle, Angle OuterAngle, Real32 OuterGain)
    {
    ...
    Bool Driver::Play(Object Handle, Category Category, Unique<Decoder> Decoder, Real32 Volume, Real32 Pitch)
    {
        Ref<Stream> Stream = mStreams[Handle];
    ...
    Bool Driver::Play(Object Handle, Category Category, Unique<Decoder> Decoder, Real32 Volume, Real32 Pitch, ConstRef<Emitter> Emitter, ConstRef<Pose> Pose)
    {
        Ref<Stream> Stream = mStreams[Handle];
        Stream.Setup(Move(Decoder));
    ...
    void Driver::SetPlaybackLooping(Object Handle, Bool Looping)
    {
    ...
    void Driver::SetPlaybackPitch(Object Handle, Real32 Pitch)
    {
    ...
    void Driver::SetPlaybackVolume(Object Handle, Real32 Volume)
    {
    ...
    void Driver::SetPlaybackPose(Object Handle, ConstRef<Pose> Pose)
    {
    ...
    void Driver::Stop(Object Handle)
    {
    ...
    void Driver::Pause(Object Handle)
    {
    ...
    void Driver::Resume(Object Handle)
    {
    ...
    void Driver::LoadCapabilities()
    {
        ...
        const auto Callback = [](Ptr<ma_context>, ma_device_type Type, ConstPtr<ma_device_info> Info, Ptr<void> User) -> ma_bool32
        {
            ...
            {
                static_cast<Ptr<Driver>>(User)->mDescription.Endpoints.Append(StrConvert(Info->name));
            }
            return MA_TRUE;
        };
